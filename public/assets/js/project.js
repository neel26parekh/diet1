...
//   // Check if email and password are provided (you can add additional validation)
//   if (email && password) {
//       // Simulate successful login and redirect to the home page
//       alert('Login successful');
//       window.location.href = 'dashboard.html';
//   } else {
//       // Handle the case when email or password is missing
